...
Sоп = 1,69 % · 4,2 = 0,071 В.\n\n"""
                ...
                "Таблица": "Параметр	Обозначение	Значение (эталон)	Единицы измерения Класс точности (основной) c c	1,0	% Класс точности (дополнительный) d d	0,5	% Верхний предел измерений U н U н ​ 10	В Измеренное напряжение U U	4,2	В Предельная относительная погрешность δ оп δ оп ​ 1,69	% Предельная абсолютная погрешность S оп S оп ​ 0,071	В"
            )
        }
    ]
}
